classdef Circular_Steel_Shaft_Diameter_Estimator_V2 < matlab.apps.AppBase
   ...
   d = ( (16*n)/pi * ( ...
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = Circular_Steel_Shaft_Diameter_Estimator_V2
